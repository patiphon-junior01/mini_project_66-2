...
<body>
    ...
    <div class="main-content">
      <div>
        <div class="number-data">
          <h4><span id="humi-now" class="animation-change-class1">60</span> <span>%</span></h4>
        </div>
      ...
      <div>
        <div class="number-data">
          <h4><span id="temp-now" class="animation-change-class2">28</span> <span>C</span></h4>
        </div>
        <div class="footer-data">
  ...
  <footer>
    <div class="w-100 d-flex justify-content-between py-3 px-4 align-items-center">
      ...
      <div>
        <span class="mx-2 mb-0 text-white"> <a href="https://github.com/patiphon-junior01/mini_project_66-2" class="text-white fs-4 mb-0" target="_blank" rel="noopener noreferrer"><i class="fab fa-github"></i></a>
        </span>
        <span class="mx-2 mb-0 text-white"> <a href="mailto:patiphonwongsee01@gmail.com" class="text-white fs-4 mb-0" target="_blank" rel="noopener noreferrer"><i class="fas fa-envelope"></i></a> </span>
      </div>
    </div>
  </footer>
